...
class UserService {
    async registration(email, password, file = 'public/uploads/default.png') {
        ...
        if (condidate.rowCount != 0) {
            ...
            const user = await db.query('INSERT INTO users (email,password,activationlink,avatar) VALUES($1,$2,$3,$4) RETURNING *', [email, hashPassword, activationLink, file])
